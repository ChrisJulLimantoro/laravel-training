...
@section('content')
        <div class="flex flex-col w-3/4 mx-auto">
            <div class="text-center mb-8">
                <h2 class="text-7xl text-white font-bold uppercase mb-4">training laravel</h2>
                <h3 class="text-3xl text-white font-bold uppercase italic mb-5">Simple crud</h3>
            </div>  
        </div>
                            ...
                            <tbody>
                                @if($person == null)
                                    <tr class="border-b bg-neutral-100">
                                        <td scope="col" colspan="3" class="text-center px-6 py-4 font-bold">Belum ada data</td>
                                    </tr>
                                @else
                                    @php
                                        $value = 1;
                                    ...
                                    @foreach ($person as $p)
                                        <tr class="border-b bg-neutral-100">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4 text-center">{{ $p['lname'].','.$p['fname'] }}</td>
                                            <td class="whitespace-nowrap text-center">
                                                <button
                                                type="button"
                                                data-te-ripple-init
                                                data-te-ripple-color="dark"
                                                id="{{ $p['link'] }};{{ $p['fname'] }};{{ $p['lname'] }}"
                                                class="edit inline-block rounded-full border border-primary p-1.5 mr-1 uppercase leading-normal shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">
                                                <svg class="w-3.5 h-3.5 fill-primary" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
